...
class Layer1(nn.Module):
    ...
    def __init__(self):
        ...
        self.br1 = BNActConv(1, 1, kernel_size=200, padding="same")
        self.br2 = BNActConv(1, 1, kernel_size=50, padding="same")
        self.br3 = BNActConv(1, 1, kernel_size=2, padding="same")
...
class Layer4(nn.Module):
    ...
    def make_blocks(self, in_channels, kernel_size, num_blocks, num_layers, threshold):
        ...
        for i in range(num_blocks):
            layers.append(GDDRBlock(in_channels, kernel_size, num_layers, threshold))
...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        self.clf = nn.Sequential(nn.Flatten(), nn.Linear(288, 256), nn.Linear(256, config.NUM_CLASSES))
