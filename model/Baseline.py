...
class Layer2(nn.Module):
    def __init__(self, scale=0.1):
        ...
        self.layer1 = BNActConv(
            3, 32, kernel_size=50, stride=2, padding=0, norm_layer=nn.BatchNorm1d, conv_layer=nn.Conv1d
        )
        self.layer2 = BNActConv(
            32, 32, kernel_size=16, stride=2, padding=0, norm_layer=nn.BatchNorm1d, conv_layer=nn.Conv1d
        )
...
class Layer3(nn.Module):
    def __init__(self, scale=1):
        ...
        self.br1 = nn.Sequential(
            BNActConv(32, 32, kernel_size=7, padding=3, norm_layer=nn.BatchNorm1d, conv_layer=nn.Conv1d),
            BNActConv(32, 32, kernel_size=7, padding=3, norm_layer=nn.BatchNorm1d, conv_layer=nn.Conv1d),
        )
        self.br2 = nn.Sequential(
            BNActConv(32, 32, kernel_size=5, padding=2, norm_layer=nn.BatchNorm1d, conv_layer=nn.Conv1d),
            BNActConv(32, 32, kernel_size=5, padding=2, norm_layer=nn.BatchNorm1d, conv_layer=nn.Conv1d),
        )
        self.br3 = nn.Sequential(
            BNActConv(32, 32, kernel_size=3, padding=1, norm_layer=nn.BatchNorm1d, conv_layer=nn.Conv1d),
            BNActConv(32, 32, kernel_size=3, padding=1, norm_layer=nn.BatchNorm1d, conv_layer=nn.Conv1d),
        )
